...
import { LayoutDashboard, Dumbbell, Map, Users, Trophy, User, LogOut, PanelLeft } from 'lucide-react'
...
const NAV_ITEMS: NavItemDef[] = [
  ...
  { href: '/run', icon: <Map className="h-4 w-4" />, label: 'Run Tracker' },
        ...
        >
          {!collapsed && (
            <>
              ...
              <span className="flex-1 font-semibold text-sm truncate uppercase tracking-tighter">FitQuest</span>
            </>
          )}
          <Tooltip>
